document.addEventListener('DOMContentLoaded', () => {
    ...
    const chordsByLevel = { 1: [{ name: 'Dó Menor (Cm)', notes: ['C', 'Eb', 'G'] },{ name: 'Ré Menor (Dm)', notes: ['D', 'F', 'A'] },{ name: 'Mi Menor (Em)', notes: ['E', 'G', 'B'] },{ name: 'Fá Menor (Fm)', notes: ['F', 'Ab', 'C'] },{ name: 'Sol Menor (Gm)', notes: ['G', 'Bb', 'D'] },{ name: 'Lá Menor (Am)', notes: ['A', 'C', 'E'] },{ name: 'Si Menor (Bm)', notes: ['B', 'D', 'F#'] }], 2: [{ name: 'Dó# Menor (C#m)', notes: ['C#', 'E', 'G#'] },{ name: 'Ré# Menor (D#m)', notes: ['D#', 'F#', 'A#'] },{ name: 'Fá# Menor (F#m)', notes: ['F#', 'A', 'C#'] },{ name: 'Sol# Menor (G#m)', notes: ['G#', 'B', 'D#'] },{ name: 'Lá# Menor (A#m)', notes: ['A#', 'C#', 'F'] }], 3: [{ name: 'Réb Menor (Dbm)', notes: ['Db', 'E', 'Ab'] },{ name: 'Mib Menor (Ebm)', notes: ['Eb', 'Gb', 'Bb'] },{ name: 'Solb Menor (Gbm)', notes: ['Gb', 'A', 'Db'] },{ name: 'Láb Menor (Abm)', notes: ['Ab', 'B', 'Eb'] },{ name: 'Sib Menor (Bbm)', notes: ['Bb', 'Db', 'F'] }]};
    ...
    function endGame(isWin) {
        ...
        if (isWin) {
            ...
            new Audio('sucess.mp3').play(); // TOCA O SEU ARQUIVO DE ÁUDIO
            showStarAnimation();
        } else {
