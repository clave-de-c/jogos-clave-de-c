document.addEventListener('DOMContentLoaded', () => {
    ...
    const instructionsBtn = document.getElementById('instructions-btn'); // Botão restaurado
    ...
    function playSuccessChime() { if (!audioCtx) return; playTone(523.25, 0.2); setTimeout(() => playTone(659.25, 0.2), 100); setTimeout(() => playTone(783.99, 0.3), 200); }
    ...
    function showScreen(screenToShow) {
        ...
        // Mostra ou esconde o botão SAIR global
    ...
    instructionsBtn.addEventListener('click', () => showScreen(instructionsScreen)); // Listener restaurado
    ...
    function endGame(isWin) { clearInterval(gameTimer); if (isWin) { endTitle.textContent = "Parabéns!"; endMessage.textContent = "Você completou o desafio!"; playSuccessChime(); showStarAnimation(); } else { endTitle.textContent = "Tempo Esgotado!"; endMessage.textContent = "Não desista, tente novamente!"; } finalScoreValue.textContent = score; showScreen(endScreen); }
    ...
    showScreen(menuScreen); // Inicia na tela de menu
});